...
#define LCD_PWR      PORTBbits.RB7                      // LCD power pin
#define LCD_EN       PORTBbits.RB6                      // LCD enable
#define LCD_RW       PORTBbits.RB5                      // LCD read/write line
#define LCD_RS       PORTBbits.RB4                      // LCD register select line
